...
Verify with: `cargo test -p daw-engine launcher_assert_no_alloc`
...
Verify with: `cargo test -p daw-engine monotonic_clock`
...
Verify with: `cargo test -p daw-engine quantized_launch`
...
Verify with: `cargo test -p daw-engine buffer_splitting`
...
Verify with: `cargo test -p daw-engine follow_action_handoff`
...
Verify with: `cargo test -p daw-engine resolve_follow_action_next`

### AC-007 — Heterogeneous scene launch

A scene launch must resolve each clip's quantization independently.

Verify with: `cargo test -p daw-engine scene_launch`
...
Verify with: `cargo test -p daw-engine midi_clip_boundary`
...
Verify with: `cargo test -p daw-engine arrangement_capture`
...
Verify with: `cargo test -p daw-engine scene_tempo_override`
...
Verify with: `cargo test -p daw-engine on_release_action`
...
Verify with: `cargo test -p daw-engine scene_follow_action`
...
Verify with: `cargo test -p daw-engine warp_map_interpolation`
...
Verify with: `cargo test -p daw-engine legato_launch`
...
Verify with: `cargo test -p daw-engine live_engine_clip_swap`
...
Verify with: `cargo test -p daw-engine global_quantize_requantize`
...
Verify with: `cargo test -p daw-engine transport_stop_during_queue`
...
Verify with: `cargo test -p daw-engine resolve_clip_block_actions`
...
Verify with: `cargo test -p daw-engine arrangement_capture_seed`
...
Verify with: `cargo test -p daw-engine play_mode_transitions`
...
Verify with: `cargo test -p daw-engine follow_actions_kill_switch`
...
Verify with: `cargo test -p daw-engine ipc_latency_budget`
...
Verify with: `cargo test -p daw-engine dsp_denormal_handling`
...
Verify with: `cargo test -p daw-engine midi_cc_chase`
...
Verify with: `cargo test -p daw-engine follow_action_ab_distribution`
...
Verify with: `cargo test -p daw-engine follow_action_no_action_terminal`
