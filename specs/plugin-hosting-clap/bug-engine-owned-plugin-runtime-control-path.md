...
sources:
  ...
  - reviews/artifact-native-command-lifecycle.md
...
```text
../sourdaw/src-tauri/src/commands/plugins.rs:159:            let wrapper = ClapWrapper::new(&entry.path, &clap_id, sample_rate)?;
../sourdaw/src-tauri/src/commands/plugins.rs:171:                    let slot = ClapPluginSlot::new(wrapper);
../sourdaw/src-tauri/src/commands/plugins.rs:172:                    let id = engine.add_plugin(Box::new(slot))?;
../sourdaw/src-tauri/src/commands/plugins.rs:186:                    engine_plugins.insert(
../sourdaw/src-tauri/src/commands/plugins.rs:426:        return Err(format!(
../sourdaw/src-tauri/src/commands/plugins.rs:459:        return Err(format!(
../sourdaw/src-tauri/src/commands/plugin_gui.rs:78:                    return Err(format!(
```
