...
```text
specs/ableton-link-sync/spec.md:27:### AC-001 - Tempo tracks a Link peer
specs/ableton-link-sync/spec.md:34:### AC-002 - Quantized start alignment
specs/ableton-link-sync/spec.md:41:### AC-003 - Clean disable
```
