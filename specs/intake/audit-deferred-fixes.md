...
description: Implementation spec for the deferred items in `inventory/overview.md`. Each section is independently implementable with verifiable acceptance criteria.
type: spec
status: open
related-audit: inventory/overview.md
---
