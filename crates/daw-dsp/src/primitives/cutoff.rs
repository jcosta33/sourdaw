...
///
/// The taper is exponential in frequency because pitch is perceived
/// logarithmically: equal movements of the control should be equal musical
/// intervals, not equal Hz. This is the standard filter-frequency taper and the
/// same one `trigger16Level.ts` uses to place the 16-Levels grid.
///
