...
//! arms across the crate. Adopting them everywhere they match keeps one
//! family's rename from silently stranding another's arm. Engines outside
//! this crate (`proof-chamber`) restate their names under the TS↔Rust
//! lockstep rule and carry a pointer comment back to this file.
