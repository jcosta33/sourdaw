...
///
/// This covers 103 of the 105 parameters the Fermenter descriptor declares
/// automatable. Two are deliberately absent because **no two values of either of
...
const AUTOMATION_PARAM_NAMES: [&str; 103] = [
    "osc_level",
    "cutoff",
    "resonance",
    "lfo_rate",
