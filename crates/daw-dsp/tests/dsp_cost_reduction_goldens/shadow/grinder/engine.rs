...
impl GrinderEngine {
    ...
    fn process_block_inner(
        ...
        for i in 0..len {
            ...
            // Pre-F9 reference: Capture still computes the circuit preamp
            // and tone stack, then the selector below discards their output.
            ...
            if should_run_circuit_rig {
                ...
                // Pre-F9 reference: every routing mode computes the second amp
                // and output transformer, while non-DualAmp routing discards it.
