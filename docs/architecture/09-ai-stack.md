...
- The exact pinned WebLLM Qwen conversions admitted by ADR 0037 are available on
  ...
  pins and verifies each artifact before storage or inference. ADR 0037 records
