...
This section extends §4 with items surfaced in `.agents/specs/plugin-hosting-clap/research.md` that were not previously covered.
...
This section extends §6.2 with the full-lifecycle requirements surfaced in `.agents/specs/orchestra/research-global-harmonic-awareness.md`. It does not replace §6.2; it operationalises it.
