...
Verify with: `cargo test -p daw-dsp fermenter::fm_is_phase_modulation`
...
Verify with: `cargo test -p daw-dsp fermenter::dx7_algorithms`
...
Verify with: `cargo test -p daw-dsp fermenter::fm_custom_routing`
...
Verify with: `cargo test -p daw-dsp fermenter::fm_feedback`
...
Verify with: `cargo test -p daw-dsp fermenter::fm_carrier_sum`
...
Verify with: `cargo test -p daw-dsp fermenter::fm_key_scaling`
