...
Verify with: `cargo test -p daw-dsp knead_latency`
...
Verify with: `cargo test -p daw-dsp knead_formant`
...
Verify with: `cargo test -p daw-dsp knead_transparency`
...
Verify with: `cargo test -p daw-dsp knead_polyphonic`
...
Verify with: `cargo test -p daw-dsp knead_phase_vocoder`
...
Verify with: `cargo test -p daw-dsp knead_transient`
...
Verify with: `cargo test -p daw-dsp knead_assignment`
...
Verify with: `cargo test -p daw-dsp knead_harmonizer`
...
Verify with: `cargo test -p daw-dsp knead_pitch_to_midi`
...
Verify with: `cargo test -p daw-dsp knead_revoice`
...
Verify with: `cargo test -p daw-dsp knead_formant_modes`
...
Verify with: `cargo test -p daw-dsp knead_formant_shift_slider`
...
Verify with: `cargo test -p daw-dsp knead_harmonizer_voice_params`
...
Verify with: `cargo test -p daw-dsp knead_harmonizer_scale_aware`
...
Verify with: `cargo test -p daw-dsp knead_mode_latency`
...
Verify with: `cargo test -p daw-dsp knead_crossover`
...
Verify with: `cargo test -p daw-dsp knead_mode_switch`
...
Verify with: `cargo test -p daw-dsp knead_secondary_tolerances`
...
Verify with: `cargo test -p daw-dsp knead_harmonizer_gain_stage`
...
Verify with: `cargo test -p daw-dsp knead_pitch_to_midi_poly`
...
Verify with: `cargo test -p daw-dsp knead_lpc_order_default`
...
Verify with: `cargo test -p daw-dsp knead_transient_thresholds`
