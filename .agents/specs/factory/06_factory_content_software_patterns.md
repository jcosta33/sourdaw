...
- [ ] **Phase 4: WAM 2.0 Descriptor Unification**: _(Pending)_ Consolidate `faustEffectDescriptors.ts` and `builtinEffectDescriptors.ts` into a unified WAM 2.0 registry structure.
