...
```
.agents/specs/architecture-refactor/task-team7-rust-core.md
```
...
Use it to track:
- **Status** — current crate/area being migrated, overall progress
...
Update this file after completing each crate and whenever you make a significant finding.
