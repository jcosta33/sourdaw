...
Verify with: `cargo test -p daw-dsp kick_808`
...
Verify with: `cargo test -p daw-dsp snare_808`
...
Verify with: `cargo test -p daw-dsp hihat_808`
...
Verify with: `cargo test -p daw-dsp poly_blep`
...
Verify with: `cargo test -p daw-dsp kick_909`
...
Verify with: `cargo test -p daw-dsp lfsr`
...
Verify with: `cargo test -p daw-dsp sp1200`
...
Verify with: `cargo test -p daw-dsp mu_law`
...
Verify with: `cargo test -p daw-dsp tolerance`
...
Verify with: `cargo test -p daw-dsp dc_block`
...
Verify with: `cargo test -p daw-dsp toaster`
...
Verify with: `cargo test -p daw-dsp denormal`
...
Verify with: `cargo test -p daw-dsp clap_808`
...
Verify with: `cargo test -p daw-dsp clap_909`
...
Verify with: `cargo test -p daw-dsp hihat_909`
...
Verify with: `cargo test -p daw-dsp perc_808`
...
Verify with: `cargo test -p daw-dsp cr78`
...
Verify with: `cargo test -p daw-dsp linndrum`
...
Verify with: `cargo test -p daw-dsp adaa`
...
Verify with: `cargo test -p daw-dsp rc_decay`
...
Verify with: `cargo test -p daw-dsp snare_909`
