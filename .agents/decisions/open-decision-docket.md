...
| **WAM plugin host**                                                       | Plugin                                                                                                                                                                 | `loadWAMPlugin` never called by any production JS (`useCases/wamPluginHost/hostOperations/loadWAMPlugin.ts`)                                                                                                                                                                                                                                                                                                            | Build host load/query + UI, or remove the host surface. **RESOLVED 2026-08-28 (#3006): host surface removed**                                                                           |
...
| ~~**GrandBoule sampled-attack**~~ _(closed — issue #3999)_                            | GrandBoule                                                                                                                                                             | Hybrid attack-clip pathway wired through types, no production caller                                                                                                                                                                                                                                                                                                                                                    | Resolved: pathway removed (#3999) — zero production callers, no clip content ships; two runtimes would have diverged                                                                  |
