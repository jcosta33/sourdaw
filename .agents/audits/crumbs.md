...
### 2. Structural & Architecture Violations

**Issue 2: Singleton UI State Prevents Multi-Instance (State Collision)**
...
**Issue 3: Audio Thread Mutex Violation**
...
**Issue 5: No Browser / WebAudio Fallback**
...
**Issue 6: Web-Incompatible File Loading**
...
### 4. Security & Stability Risks

**Issue 7: Unbounded Memory Allocation on File Load (OOM Risk)**
...
**Issue 8: Catastrophic 60fps Full-Panel Re-render**
...
**Issue 9: Inefficient IPC Polling for Playhead Position**
...
**Issue 10: Naive Loop Parameter Submission**
...
### 6. UX / Naming Inconsistencies

**Issue 11: "Crumbs" vs "Sampler" Identity Crisis**
