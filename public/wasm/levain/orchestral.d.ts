...
export interface InitOutput {
    ...
    readonly __wbg_orchestrainstance_free: (a: number, b: number) => void;
    readonly orchestrainstance_active_voices: (a: number) => number;
    readonly orchestrainstance_add_sample: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
    readonly orchestrainstance_add_zone: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number) => void;
    readonly orchestrainstance_build_zone_map: (a: number, b: number, c: number) => void;
    readonly orchestrainstance_get_right_ptr: (a: number) => number;
    readonly orchestrainstance_handle_cc: (a: number, b: number, c: number) => void;
    readonly orchestrainstance_new: (a: number, b: number) => number;
    readonly orchestrainstance_note_off: (a: number, b: number) => void;
    readonly orchestrainstance_note_on: (a: number, b: number, c: number) => void;
    readonly orchestrainstance_process: (a: number, b: number) => number;
    readonly orchestrainstance_set_param: (a: number, b: number, c: number, d: number) => void;
