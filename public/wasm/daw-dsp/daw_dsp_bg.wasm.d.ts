...
export const __wbg_get_proofchamberengine_mix: (a: number) => number;
export const __wbg_get_proofchamberengine_pre_delay_ms: (a: number) => number;
export const __wbg_grinderinstance_free: (a: number, b: number) => void;
export const __wbg_proofchamberengine_free: (a: number, b: number) => void;
export const __wbg_set_proofchamberengine_mix: (a: number, b: number) => void;
export const __wbg_set_proofchamberengine_pre_delay_ms: (a: number, b: number) => void;
...
export const proofchamberengine_get_input_left_ptr: (a: number) => number;
export const proofchamberengine_get_input_right_ptr: (a: number) => number;
export const proofchamberengine_get_output_left_ptr: (a: number) => number;
export const proofchamberengine_get_output_right_ptr: (a: number) => number;
export const proofchamberengine_new: (a: number) => number;
export const proofchamberengine_process_block: (a: number, b: number) => void;
export const proofchamberengine_set_parameters: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
