...
export const commit_pitch_edit_wasm: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
...
export const grandbouleinstance_active_voices: (a: number) => number;
...
export const grandbouleinstance_push_note_expression: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
export const grandbouleinstance_push_note_off: (a: number, b: number, c: number) => number;
export const grandbouleinstance_push_note_off_on_channel: (a: number, b: number, c: number, d: number) => number;
export const grandbouleinstance_push_note_on: (a: number, b: number, c: number, d: number, e: number) => number;
...
export const crumbsinstance_dropped_sample_writes: (a: number) => number;
...
export const levaininstance_add_articulation_switch: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
