...
export const fermenterinstance_schedule_note_expression: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
export const fermenterinstance_schedule_note_off: (a: number, b: number, c: number, d: number) => number;
export const fermenterinstance_schedule_note_on: (a: number, b: number, c: number, d: number, e: number) => number;
...
export const fermenterinstance_tail_samples: (a: number) => number;
...
export const levaininstance_advance_silence: (a: number, b: number) => void;
export const levaininstance_all_notes_off: (a: number) => void;
export const levaininstance_all_sounds_off: (a: number) => void;
...
export const levaininstance_lifecycle_state: (a: number) => number;
