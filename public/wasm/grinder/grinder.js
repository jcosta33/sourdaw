...
export class GrinderInstance {
    ...
    constructor(sample_rate, num_pads) {
        const ret = wasm.grinderinstance_new(sample_rate, num_pads);
     ...
     */
    note_off(pad) {
        wasm.grinderinstance_note_off(this.__wbg_ptr, pad);
    }
    /**
    ...
    note_on(pad, velocity, midi_note) {
        wasm.grinderinstance_note_on(this.__wbg_ptr, pad, velocity, midi_note);
    }
    /**
    ...
    set_pad_param(pad, name, value) {
        ...
        wasm.grinderinstance_set_pad_param(this.__wbg_ptr, pad, ptr0, len0, value);
    }
    /**
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('grinder_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
