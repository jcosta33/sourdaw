...
export interface InitOutput {
    ...
    readonly grinderinstance_new: (a: number, b: number) => number;
    readonly grinderinstance_note_off: (a: number, b: number) => void;
    readonly grinderinstance_note_on: (a: number, b: number, c: number, d: number) => void;
    readonly grinderinstance_process: (a: number, b: number) => number;
    readonly grinderinstance_set_pad_param: (a: number, b: number, c: number, d: number, e: number) => void;
