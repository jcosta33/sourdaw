...
export const STEP_INVENTORY: Readonly<Record<string, Readonly<Record<string, readonly string[] | null>>>> = {
    ...
    'validation.yml': {
        ...
        lint: ['Checkout', 'Set up pnpm', 'Set up Node', 'Install dependencies', 'Lint'],
        boundaries: ['Checkout', 'Set up pnpm', 'Set up Node', 'Install dependencies', 'Validate the dependency graph'],
        unit: ['Checkout', 'Set up pnpm', 'Set up Node', 'Install dependencies', 'Run shard', 'Report shard failure'],
        smoke: [
            'Checkout',
            'Set up pnpm',
            'Set up Node',
        ...
        build: ['Checkout', 'Set up pnpm', 'Set up Node', 'Install dependencies', 'Build'],
        rust: [
            'Checkout',
            'Set up pnpm',
            'Set up Node',
...
function readHostedWasmWorkflowMapping(candidate: unknown): Record<string, unknown> {
