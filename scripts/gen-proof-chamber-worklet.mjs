...
// Replace `new URL('proof_chamber_bg.wasm', import.meta.url)` so Vite doesn't try to
...
generated = generated.replace(
    ...
    "module_or_path = '/wasm/proof-chamber/proof_chamber_bg.wasm'; // served from public/",
);
