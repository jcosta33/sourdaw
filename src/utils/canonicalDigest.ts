/**
 * Canonical serialization and its SHA-256 digest, shared by every route that needs one stable
 * identity for a structured value: agent-context evidence, the creative interpretation catalog, and
 * the correction's authority comparison. Written once because two copies of a canonical form drift
