...
describe('Divider', () => {
    ...
    describe('axis prop', () => {
        it('defaults to horizontal (x) with correct classes', () => {
            render(<Divider data-testid="divider" />);
            const element = screen.getByTestId('divider');
        ...
        it('axis="y" creates vertical divider', () => {
    ...
    describe('tone prop', () => {
        it.each([
            ...
            ['strong', 'bg-border/60'],
        ] as const)('tone "%s" applies %s class', (tone, expectedClass) => {
    ...
    describe('spacing prop', () => {
        describe('horizontal axis (x)', () => {
            it.each([
                ...
                [3, 'mx-3'],
                [4, 'mx-4'],
            ] as const)('spacing %i applies %s class', (spacing, expectedClass) => {
