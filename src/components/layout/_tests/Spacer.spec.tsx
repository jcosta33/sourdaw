...
describe('Spacer', () => {
    ...
    describe('size prop', () => {
        it.each([
            ...
            [12, 'w-12', 'h-12'],
            [16, 'w-16', 'h-16'],
        ] as const)('size %i applies both width and height classes', (size, widthClass, heightClass) => {
    ...
    describe('axis prop', () => {
        ...
        it('axis="y" applies only height class', () => {
        ...
        it('defaults to both axes when axis is not specified', () => {
