...
export const LED = ({ on, variant = 'amber', size = 'md', className }: LEDProps): ReactElement => {
    ...
    return (
        <div
            className={cn(
                'rounded-full transition-[background,box-shadow,filter] duration-fast',
                sizeStyles[size],
                className
            )}
            style={{
                ...
                boxShadow: on ? active.shadow : 'inset 0 1px 2px rgba(0,0,0,0.6), 0 1px 0 rgba(255,255,255,0.03)',
