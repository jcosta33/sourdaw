    ...
    <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col items-center gap-0.5">
                <RotaryKnob value={partials} onChange={(v) => onParam('additivePartials', v)} min={1} max={64} step={1} defaultValue={32} size="lg" />
            ...
            <div className="flex flex-col items-center gap-0.5">
                <RotaryKnob value={tilt} onChange={(v) => onParam('additiveTilt', v)} min={-6} max={6} step={0.1} defaultValue={0} size="lg" />
            ...
            <div className="flex flex-col items-center gap-0.5">
                <RotaryKnob value={oddEmphasis} onChange={(v) => onParam('additiveOdd', v)} min={0} max={1} step={0.01} defaultValue={0} size="lg" />
            ...
            <div className="flex flex-col items-center gap-0.5">
                <RotaryKnob value={inharmonicity} onChange={(v) => onParam('additiveInharm', v)} min={0} max={0.1} step={0.001} defaultValue={0} size="lg" />
                <span className="text-[7px] text-muted-foreground">Inharm</span>
                <span className="text-[6px] text-muted-foreground/50 font-mono">{(inharmonicity * 1000).toFixed(1)}</span>
            </div>
        </div>
    </div>
);
