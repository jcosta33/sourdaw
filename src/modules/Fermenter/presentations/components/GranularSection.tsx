...
export const GranularSection = ({
    density, size, position, spray, pitchVar, panSpread, onParam,
    ...
    <div className="space-y-2">
        ...
        <div className="grid grid-cols-3 gap-2">
            <div className="flex flex-col items-center gap-0.5">
                <RotaryKnob value={density} onChange={(v) => onParam('grainDensity', v)} min={1} max={100} step={1} defaultValue={20} size="lg" />
            ...
            <div className="flex flex-col items-center gap-0.5">
                <RotaryKnob value={size} onChange={(v) => onParam('grainSize', v)} min={5} max={500} step={1} defaultValue={50} size="lg" />
            ...
            <div className="flex flex-col items-center gap-0.5">
                <RotaryKnob value={position} onChange={(v) => onParam('grainPosition', v)} min={0} max={1} step={0.01} defaultValue={0} size="lg" />
                <span className="text-[7px] text-muted-foreground">Position</span>
            </div>
            <div className="flex flex-col items-center gap-0.5">
                <RotaryKnob value={spray} onChange={(v) => onParam('grainSpray', v)} min={0} max={1} step={0.01} defaultValue={0.1} size="lg" />
                <span className="text-[7px] text-muted-foreground">Spray</span>
            </div>
            <div className="flex flex-col items-center gap-0.5">
                <RotaryKnob value={pitchVar} onChange={(v) => onParam('grainPitchVar', v)} min={0} max={12} step={0.1} defaultValue={0} size="lg" />
            ...
            <div className="flex flex-col items-center gap-0.5">
                <RotaryKnob value={panSpread} onChange={(v) => onParam('grainPanSpread', v)} min={0} max={1} step={0.01} defaultValue={0.5} size="lg" />
