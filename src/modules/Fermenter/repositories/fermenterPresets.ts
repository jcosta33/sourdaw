...
export const FERMENTER_PRESETS: SoundPreset[] = [
    ...
    p('cello', 'Rye Cello', 'strings', 'Solo cello emulation — rich and resonant', ['cello', 'solo', 'levain'], { oscEngine: 1, oscWaveform: 1, filterModel: 1, filterCutoff: 1800, filterResonance: 1.5, ampAttack: 0.15, ampSustain: 0.8, ampRelease: 0.4, lfoRate: 5.5, lfoPitchAmount: 0.02, reverbMix: 0.3, reverbDecay: 0.6 }),
    ...
    p('trumpet', 'Trumpet Loaf', 'synth', 'Trumpet — bright brass with filter attack simulating valve opening', ['trumpet', 'brass', 'levain'], { oscEngine: 1, oscWaveform: 1, filterModel: 0, filterCutoff: 800, filterResonance: 2, ampAttack: 0.04, ampDecay: 0.15, ampSustain: 0.75, ampRelease: 0.15, filterAttack: 0.03, filterDecay: 0.15, filterSustain: 0.5, filterEnvAmount: 0.85, lfoRate: 5.5, lfoPitchAmount: 0.015, reverbMix: 0.2 }),
    p('trombone', 'Trombone Baguette', 'synth', 'Trombone — warm, mellow brass with slow attack', ['trombone', 'brass', 'levain'], { oscEngine: 1, oscWaveform: 1, filterModel: 1, filterCutoff: 600, filterResonance: 1.5, ampAttack: 0.06, ampSustain: 0.7, ampRelease: 0.2, filterAttack: 0.05, filterEnvAmount: 0.7, lfoRate: 5, lfoPitchAmount: 0.012, reverbMix: 0.25 }),
    p('french-horn', 'Croissant Horn', 'synth', 'French horn — round, noble brass with dark warmth', ['horn', 'brass', 'levain'], { oscEngine: 1, oscWaveform: 1, unisonVoices: 2, unisonDetune: 3, filterModel: 1, filterCutoff: 500, filterResonance: 1.2, ampAttack: 0.1, ampSustain: 0.8, ampRelease: 0.3, filterAttack: 0.08, filterEnvAmount: 0.5, lfoRate: 4.5, lfoPitchAmount: 0.01, reverbMix: 0.35, reverbDecay: 0.6 }),
    p('tuba', 'Tuba Pumpernickel', 'bass', 'Tuba — deep, round brass foundation', ['tuba', 'brass', 'levain'], { oscEngine: 1, oscWaveform: 1, filterModel: 1, filterCutoff: 400, filterResonance: 1, ampAttack: 0.08, ampSustain: 0.7, ampRelease: 0.2, filterAttack: 0.06, filterEnvAmount: 0.4, reverbMix: 0.2 }),
    p('flute', 'Flute Flour', 'synth', 'Concert flute — sine + breath noise with vibrato', ['flute', 'woodwind', 'levain'], { oscWaveform: 0, oscLevel: 0.7, noiseLevel: 0.15, noiseColor: 0, filterCutoff: 6000, filterResonance: 1.5, ampAttack: 0.08, ampSustain: 0.8, ampRelease: 0.15, lfoRate: 5, lfoPitchAmount: 0.02, reverbMix: 0.25 }),
    p('clarinet', 'Clarinet Cracker', 'synth', 'Clarinet — square wave (odd harmonics) with soft reed attack', ['clarinet', 'woodwind', 'levain'], { oscEngine: 1, oscWaveform: 2, filterModel: 0, filterCutoff: 2000, filterResonance: 1.5, ampAttack: 0.05, ampSustain: 0.8, ampRelease: 0.1, filterAttack: 0.04, filterEnvAmount: 0.3, lfoRate: 5.5, lfoPitchAmount: 0.01, reverbMix: 0.2 }),
    p('oboe', 'Oboe Olive', 'synth', 'Oboe — nasal double-reed with thin, piercing tone', ['oboe', 'woodwind', 'levain'], { oscEngine: 1, oscWaveform: 1, filterModel: 3, filterCutoff: 4000, filterResonance: 3, ampAttack: 0.04, ampSustain: 0.75, ampRelease: 0.1, lfoRate: 5.5, lfoPitchAmount: 0.015, reverbMix: 0.2 }),
    p('bassoon', 'Bassoon Brioche', 'synth', 'Bassoon — dark, reedy double-reed bass woodwind', ['bassoon', 'woodwind', 'levain'], { oscEngine: 1, oscWaveform: 1, filterModel: 3, filterCutoff: 2000, filterResonance: 2.5, ampAttack: 0.05, ampSustain: 0.7, ampRelease: 0.15, lfoRate: 4.5, lfoPitchAmount: 0.012, reverbMix: 0.2 }),
    ...
    p('tubular-bells', 'Cathedral Bells', 'keys', 'Tubular bells — deep inharmonic levain chimes', ['tubular', 'bell', 'levain'], { oscEngine: 5, additivePartials: 20, additiveTilt: 0.5, additiveInharm: 0.025, filterCutoff: 12000, ampAttack: 0.001, ampDecay: 5, ampSustain: 0, ampRelease: 3, reverbMix: 0.5, reverbDecay: 0.85 }),
    ...
    p('cello-solo', 'Rye Cello Solo', 'strings', 'Cello — rich, warm solo voice with expressive vibrato', ['cello', 'solo', 'levain', 'bowed'], { oscEngine: 1, oscWaveform: 1, oscDrift: 0.15, filterModel: 1, filterCutoff: 1800, filterResonance: 1.5, ampAttack: 0.15, ampSustain: 0.85, ampRelease: 0.4, lfoRate: 5.5, lfoPitchAmount: 0.02, reverbMix: 0.3, reverbDecay: 0.6 }),
    p('viola', 'Viola Brioche', 'strings', 'Viola — darker, warmer cousin of the violin', ['viola', 'levain', 'bowed'], { oscEngine: 1, oscWaveform: 1, filterCutoff: 2500, filterResonance: 1.3, ampAttack: 0.12, ampSustain: 0.8, ampRelease: 0.3, lfoRate: 5.8, lfoPitchAmount: 0.018, reverbMix: 0.25 }),
    p('contrabass', 'Double Dough Bass', 'bass', 'Contrabass — deep bowed levain bass', ['contrabass', 'levain', 'bowed'], { oscEngine: 1, oscWaveform: 1, filterModel: 1, filterCutoff: 1200, filterResonance: 1, ampAttack: 0.2, ampSustain: 0.8, ampRelease: 0.5, lfoRate: 4.5, lfoPitchAmount: 0.01, reverbMix: 0.3 }),
    p('string-section', 'Whole Wheat Section', 'strings', 'Full string section — lush ensemble with width', ['strings', 'section', 'levain', 'ensemble'], { oscEngine: 1, oscWaveform: 1, oscDrift: 0.25, unisonVoices: 6, unisonDetune: 15, unisonSpread: 1, filterModel: 5, filterCutoff: 3500, filterResonance: 1, ampAttack: 0.4, ampSustain: 0.85, ampRelease: 1, chorusMix: 0.2, reverbMix: 0.35, reverbDecay: 0.6, stereoWidth: 1.4 }),
];
