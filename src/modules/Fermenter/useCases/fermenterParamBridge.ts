...
function createFlushParam(updateDeviceParamFn: UpdateDeviceParamFn, persistDeviceParamFn: PersistDeviceParamFn) {
 ...
 */
export function setFermenterParamWithAudio() {
...
export function loadFermenterPatchWithAudio() {
    const findDeviceRef = createFindDeviceRef(getAllTracksFn);
