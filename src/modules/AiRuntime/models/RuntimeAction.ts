...
export const RUNTIME_ACTION_OVERRIDE_PAYLOAD_KEYS = {
    ...
    setTrackGain: ['trackId', 'gain', 'gainDb', 'deltaDb'],
    setTrackPan: ['trackId', 'pan'],
    setMasterGain: ['gain', 'gainDb', 'deltaDb'],
    ...
    setClipGain: ['clipId', 'gain', 'gainDb', 'deltaDb'],
    ...
    glueClips: ['clipIds'],
    stripSilence: ['clipId', 'threshold', 'minDuration'],
    ...
    quantizeNotes: ['clipId', 'gridSize', 'noteIds'],
    ...
    transposeNotes: ['clipId', 'semitones', 'noteIds'],
