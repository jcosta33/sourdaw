...
describe('parseEditPlan', () => {
    it('should parse a well-formed EditPlan directly', () => {
    ...
    it('should salvage an EditPlan embedded in prose', () => {
    ...
    it('should honor braces inside string literals when scanning', () => {
    ...
    it('should reject a parseable object with an invalid moderation value', () => {
        const raw = JSON.stringify({ kind: 'edit_plan', moderation: 'maybe', intent: 'x', dsos: [] });
        expect(() => parseEditPlan(raw)).toThrow(/moderation/);
    });

    it('should reject a plan whose dsos contain an unknown op', () => {
    ...
    it('should not catastrophically backtrack on adversarial unbalanced input', () => {
    ...
    it('should cap the salvage scan at the size limit (oversized input still returns fast)', () => {
