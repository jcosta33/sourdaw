...
describe('toolSelector', () => {
    ...
    const allTools: ToolSchema[] = [
        // CORE TOOLS
        'addTrack', 'removeTrack', 'setTrackGain', 'setTrackPan', 
        'muteTrack', 'soloTrack', 'setTempo', 'togglePlayback',
        // KEYWORD TOOLS
        'duplicateTrack', 'addNotes', 'completeMidi', 'analyzeMix',
        'addDevice', 'removeDevice', 'addSend', 'stemSeparate',
        // RANDOM UNRELATED TOOLS
        'unrelatedTool1', 'unrelatedTool2'
