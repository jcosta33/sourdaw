...
export const InviteCodeRow = ({ value, copied, onCopy, className }: InviteCodeRowProps): ReactElement => (
    <div className={cn('flex items-center gap-1.5 rounded-md border border-white/8 bg-black/20 px-2 py-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.02)]', className)}>
