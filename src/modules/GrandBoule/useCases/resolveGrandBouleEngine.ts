...
export const resolveGrandBouleEngine = inject({ createDisconnectedGrandBouleEngineHandle })(
    ({ createDisconnectedGrandBouleEngineHandle }) =>
        function resolveGrandBouleEngine(input: ResolveGrandBouleEngineInput): ResolvedGrandBouleEngine {
