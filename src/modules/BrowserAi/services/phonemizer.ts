...
const EXCEPTION_DICT: Record<string, string[]> = {
    ...
    all: ['AO', 'L'], both: ['B', 'OW', 'TH'],
    each: ['IY', 'CH'], every: ['EH', 'V', 'R', 'IY'],
    no: ['N', 'OW'], such: ['S', 'AH', 'CH'],
    much: ['M', 'AH', 'CH'], many: ['M', 'EH', 'N', 'IY'],
    few: ['F', 'Y', 'UW'], little: ['L', 'IH', 'T', 'AH', 'L'],
    less: ['L', 'EH', 'S'], more: ['M', 'AO', 'R'],
    most: ['M', 'OW', 'S', 'T'], enough: ['IH', 'N', 'AH', 'F'],
    several: ['S', 'EH', 'V', 'R', 'AH', 'L'],
    another: ['AH', 'N', 'AH', 'DH', 'ER'],
    other: ['AH', 'DH', 'ER'], either: ['IY', 'DH', 'ER'],
    neither: ['N', 'IY', 'DH', 'ER'],
    ...
    mine: ['M', 'AY', 'N'], yours: ['Y', 'AO', 'R', 'Z'],
    hers: ['HH', 'ER', 'Z'], ours: ['AW', 'ER', 'Z'],
    theirs: ['DH', 'EH', 'R', 'Z'],
    ...
    who: ['HH', 'UW'], whom: ['HH', 'UW', 'M'],
    whose: ['HH', 'UW', 'Z'], what: ['W', 'AH', 'T'],
    which: ['W', 'IH', 'CH'], whatever: ['W', 'AH', 'T', 'EH', 'V', 'ER'],
    ...
    to: ['T', 'AH'], for: ['F', 'AO', 'R'],
    with: ['W', 'IH', 'DH'], from: ['F', 'R', 'AH', 'M'],
    by: ['B', 'AY'], about: ['AH', 'B', 'AW', 'T'],
    ...
    up: ['AH', 'P'], down: ['D', 'AW', 'N'],
    out: ['AW', 'T'], off: ['AO', 'F'],
    over: ['OW', 'V', 'ER'], under: ['AH', 'N', 'D', 'ER'],
    near: ['N', 'IH', 'R'], among: ['AH', 'M', 'AH', 'NG'],
    along: ['AH', 'L', 'AO', 'NG'],
    across: ['AH', 'K', 'R', 'AO', 'S'],
    around: ['AH', 'R', 'AW', 'N', 'D'],
    ...
    // ── Conjunctions ─────────────────────────────────────────────────────────
    and: ['AE', 'N', 'D'], but: ['B', 'AH', 'T'],
    or: ['AO', 'R'], so: ['S', 'OW'],
    yet: ['Y', 'EH', 'T'], nor: ['N', 'AO', 'R'],
    although: ['AO', 'L', 'DH', 'OW'],
    because: ['B', 'IH', 'K', 'AO', 'Z'],
    while: ['W', 'AY', 'L'],
    though: ['DH', 'OW'],
    ...
    im: ['AY', 'M'], ive: ['AY', 'V'],
    youre: ['Y', 'AO', 'R'], youve: ['Y', 'UW', 'V'],
    youll: ['Y', 'UW', 'L'], youd: ['Y', 'UH', 'D'],
    hes: ['HH', 'IY', 'Z'], hell: ['HH', 'IY', 'L'],
    shes: ['SH', 'IY', 'Z'], shell: ['SH', 'IY', 'L'],
    weve: ['W', 'IY', 'V'],
    weve2: ['W', 'IY', 'V'],
    theyre: ['DH', 'EH', 'R'], theyve: ['DH', 'EY', 'V'],
    theyll: ['DH', 'EY', 'L'], theyd: ['DH', 'EY', 'D'],
    dont: ['D', 'OW', 'N', 'T'], doesnt: ['D', 'AH', 'Z', 'AH', 'N', 'T'],
    didnt: ['D', 'IH', 'D', 'AH', 'N', 'T'],
    cant: ['K', 'AE', 'N', 'T'], couldnt: ['K', 'UH', 'D', 'AH', 'N', 'T'],
    wont: ['W', 'OW', 'N', 'T'], wouldnt: ['W', 'UH', 'D', 'AH', 'N', 'T'],
    shouldnt: ['SH', 'UH', 'D', 'AH', 'N', 'T'],
    hasnt: ['HH', 'AE', 'Z', 'AH', 'N', 'T'],
    havent: ['HH', 'AE', 'V', 'AH', 'N', 'T'],
    hadnt: ['HH', 'AE', 'D', 'AH', 'N', 'T'],
    isnt: ['IH', 'Z', 'AH', 'N', 'T'], arent: ['AA', 'R', 'AH', 'N', 'T'],
    wasnt: ['W', 'AH', 'Z', 'AH', 'N', 'T'],
    werent: ['W', 'ER', 'AH', 'N', 'T'],
    thats: ['DH', 'AE', 'T', 'S'], whats: ['W', 'AH', 'T', 'S'],
    lets: ['L', 'EH', 'T', 'S'],
    aint: ['EY', 'N', 'T'],
    gonna: ['G', 'AO', 'N', 'AH'], wanna: ['W', 'AO', 'N', 'AH'],
    gotta: ['G', 'AA', 'T', 'AH'], kinda: ['K', 'AY', 'N', 'D', 'AH'],
    sorta: ['S', 'AO', 'R', 'T', 'AH'], outta: ['AW', 'T', 'AH'],
    lotta: ['L', 'AA', 'T', 'AH'],

    // ── Common adverbs ────────────────────────────────────────────────────────
    very: ['V', 'EH', 'R', 'IY'], really: ['R', 'IY', 'AH', 'L', 'IY'],
    just: ['JH', 'AH', 'S', 'T'], now: ['N', 'AW'],
    then: ['DH', 'EH', 'N'], here: ['HH', 'IH', 'R'],
    there: ['DH', 'EH', 'R'], well: ['W', 'EH', 'L'],
    too: ['T', 'UW'], also: ['AO', 'L', 'S', 'OW'],
    only: ['OW', 'N', 'L', 'IY'], still: ['S', 'T', 'IH', 'L'],
    even: ['IY', 'V', 'AH', 'N'], never: ['N', 'EH', 'V', 'ER'],
    always: ['AO', 'L', 'W', 'EY', 'Z'],
    often: ['AO', 'F', 'AH', 'N'],
    sometimes: ['S', 'AH', 'M', 'T', 'AY', 'M', 'Z'],
    already: ['AO', 'L', 'R', 'EH', 'D', 'IY'],
    again: ['AH', 'G', 'EH', 'N'],
    away: ['AH', 'W', 'EY'], back: ['B', 'AE', 'K'],
    ever: ['EH', 'V', 'ER'], almost: ['AO', 'L', 'M', 'OW', 'S', 'T'],
    maybe: ['M', 'EY', 'B', 'IY'], perhaps: ['P', 'ER', 'HH', 'AE', 'P', 'S'],
    together: ['T', 'AH', 'G', 'EH', 'DH', 'ER'],
    apart: ['AH', 'P', 'AA', 'R', 'T'],
    far: ['F', 'AA', 'R'], hard: ['HH', 'AA', 'R', 'D'],
    long: ['L', 'AO', 'NG'],
    twice: ['T', 'W', 'AY', 'S'], soon: ['S', 'UW', 'N'],
    fast: ['F', 'AE', 'S', 'T'], slowly: ['S', 'L', 'OW', 'L', 'IY'],
    ...
    go: ['G', 'OW'], get: ['G', 'EH', 'T'],
    come: ['K', 'AH', 'M'], give: ['G', 'IH', 'V'],
    take: ['T', 'EY', 'K'], make: ['M', 'EY', 'K'],
    know: ['N', 'OW'], see: ['S', 'IY'],
    say: ['S', 'EY'], think: ['TH', 'IH', 'NG', 'K'],
    feel: ['F', 'IY', 'L'], find: ['F', 'AY', 'N', 'D'],
    tell: ['T', 'EH', 'L'], become: ['B', 'IH', 'K', 'AH', 'M'],
    keep: ['K', 'IY', 'P'], let: ['L', 'EH', 'T'],
    hold: ['HH', 'OW', 'L', 'D'],
    bring: ['B', 'R', 'IH', 'NG'], buy: ['B', 'AY'],
    build: ['B', 'IH', 'L', 'D'], catch: ['K', 'AE', 'CH'],
    choose: ['CH', 'UW', 'Z'], draw: ['D', 'R', 'AO'],
    drink: ['D', 'R', 'IH', 'NG', 'K'], drive: ['D', 'R', 'AY', 'V'],
    eat: ['IY', 'T'], fall: ['F', 'AO', 'L'],
    fight: ['F', 'AY', 'T'], fly: ['F', 'L', 'AY'],
    forget: ['F', 'ER', 'G', 'EH', 'T'], grow: ['G', 'R', 'OW'],
    hear: ['HH', 'IH', 'R'], hurt: ['HH', 'ER', 'T'],
    leave: ['L', 'IY', 'V'], lose: ['L', 'UW', 'Z'],
    mean: ['M', 'IY', 'N'], meet: ['M', 'IY', 'T'],
    pay: ['P', 'EY'], put: ['P', 'UH', 'T'],
    read: ['R', 'IY', 'D'], ride: ['R', 'AY', 'D'],
    ring: ['R', 'IH', 'NG'], rise: ['R', 'AY', 'Z'],
    run: ['R', 'AH', 'N'], sell: ['S', 'EH', 'L'],
    send: ['S', 'EH', 'N', 'D'], set: ['S', 'EH', 'T'],
    shake: ['SH', 'EY', 'K'], show: ['SH', 'OW'],
    sing: ['S', 'IH', 'NG'], sit: ['S', 'IH', 'T'],
    sleep: ['S', 'L', 'IY', 'P'], speak: ['S', 'P', 'IY', 'K'],
    spend: ['S', 'P', 'EH', 'N', 'D'], stand: ['S', 'T', 'AE', 'N', 'D'],
    steal: ['S', 'T', 'IY', 'L'], swim: ['S', 'W', 'IH', 'M'],
    teach: ['T', 'IY', 'CH'], throw: ['TH', 'R', 'OW'],
    wake: ['W', 'EY', 'K'], wear: ['W', 'EH', 'R'],
    win: ['W', 'IH', 'N'], write: ['R', 'AY', 'T'],
    break: ['B', 'R', 'EY', 'K'], walk: ['W', 'AO', 'K'],
    talk: ['T', 'AO', 'K'], call: ['K', 'AO', 'L'],
    turn: ['T', 'ER', 'N'], move: ['M', 'UW', 'V'],
    live: ['L', 'IH', 'V'], love: ['L', 'AH', 'V'],
    care: ['K', 'EH', 'R'], share: ['SH', 'EH', 'R'],
    start: ['S', 'T', 'AA', 'R', 'T'], stop: ['S', 'T', 'AA', 'P'],
    work: ['W', 'ER', 'K'], wait: ['W', 'EY', 'T'],
    try: ['T', 'R', 'AY'], cry: ['K', 'R', 'AY'],
    pray: ['P', 'R', 'EY'], play: ['P', 'L', 'EY'],
    stay: ['S', 'T', 'EY'], lay: ['L', 'EY'],
    lie: ['L', 'AY'], die: ['D', 'AY'],
    follow: ['F', 'AA', 'L', 'OW'], pull: ['P', 'UH', 'L'],
    push: ['P', 'UH', 'SH'], open: ['OW', 'P', 'AH', 'N'],
    close: ['K', 'L', 'OW', 'Z'], reach: ['R', 'IY', 'CH'],
    touch: ['T', 'AH', 'CH'], watch: ['W', 'AA', 'CH'],
    listen: ['L', 'IH', 'S', 'AH', 'N'],
    dance: ['D', 'AE', 'N', 'S'], breathe: ['B', 'R', 'IY', 'DH'],
    shine: ['SH', 'AY', 'N'], smile: ['S', 'M', 'AY', 'L'],
    save: ['S', 'EY', 'V'], fade: ['F', 'EY', 'D'],
    hide: ['HH', 'AY', 'D'], chase: ['CH', 'EY', 'S'],
    face: ['F', 'EY', 'S'], place: ['P', 'L', 'EY', 'S'],
    raise: ['R', 'EY', 'Z'],

    // ── Irregular verbs: past tense ───────────────────────────────────────────
    went: ['W', 'EH', 'N', 'T'], got: ['G', 'AA', 'T'],
    came: ['K', 'EY', 'M'], gave: ['G', 'EY', 'V'],
    took: ['T', 'UH', 'K'], made: ['M', 'EY', 'D'],
    knew: ['N', 'Y', 'UW'], saw: ['S', 'AO'],
    said: ['S', 'EH', 'D'], thought: ['TH', 'AO', 'T'],
    felt: ['F', 'EH', 'L', 'T'], found: ['F', 'AW', 'N', 'D'],
    told: ['T', 'OW', 'L', 'D'], became: ['B', 'IH', 'K', 'EY', 'M'],
    kept: ['K', 'EH', 'P', 'T'], held: ['HH', 'EH', 'L', 'D'],
    brought: ['B', 'R', 'AO', 'T'], bought: ['B', 'AO', 'T'],
    built: ['B', 'IH', 'L', 'T'], caught: ['K', 'AO', 'T'],
    chose: ['CH', 'OW', 'Z'], drew: ['D', 'R', 'UW'],
    drank: ['D', 'R', 'AE', 'NG', 'K'], drove: ['D', 'R', 'OW', 'V'],
    ate: ['EY', 'T'], fell: ['F', 'EH', 'L'],
    fought: ['F', 'AO', 'T'], flew: ['F', 'L', 'UW'],
    forgot: ['F', 'ER', 'G', 'AA', 'T'], grew: ['G', 'R', 'UW'],
    heard: ['HH', 'ER', 'D'], left: ['L', 'EH', 'F', 'T'],
    lost: ['L', 'AO', 'S', 'T'], meant: ['M', 'EH', 'N', 'T'],
    met: ['M', 'EH', 'T'], paid: ['P', 'EY', 'D'],
    rode: ['R', 'OW', 'D'], rang: ['R', 'AE', 'NG'],
    rose: ['R', 'OW', 'Z'], ran: ['R', 'AE', 'N'],
    sold: ['S', 'OW', 'L', 'D'], sent: ['S', 'EH', 'N', 'T'],
    shook: ['SH', 'UH', 'K'], showed: ['SH', 'OW', 'D'],
    sang: ['S', 'AE', 'NG'], sat: ['S', 'AE', 'T'],
    slept: ['S', 'L', 'EH', 'P', 'T'], spoke: ['S', 'P', 'OW', 'K'],
    spent: ['S', 'P', 'EH', 'N', 'T'], stood: ['S', 'T', 'UH', 'D'],
    stole: ['S', 'T', 'OW', 'L'], struck: ['S', 'T', 'R', 'AH', 'K'],
    swam: ['S', 'W', 'AE', 'M'], taught: ['T', 'AO', 'T'],
    threw: ['TH', 'R', 'UW'], woke: ['W', 'OW', 'K'],
    wore: ['W', 'AO', 'R'], won: ['W', 'AH', 'N'],
    wrote: ['R', 'OW', 'T'], broke: ['B', 'R', 'OW', 'K'],
    walked: ['W', 'AO', 'K', 'T'], talked: ['T', 'AO', 'K', 'T'],
    called: ['K', 'AO', 'L', 'D'], turned: ['T', 'ER', 'N', 'D'],
    moved: ['M', 'UW', 'V', 'D'], loved: ['L', 'AH', 'V', 'D'],
    lived: ['L', 'IH', 'V', 'D'],

    // ── Past participles (where different from past tense) ────────────────────
    gone: ['G', 'AO', 'N'], given: ['G', 'IH', 'V', 'AH', 'N'],
    taken: ['T', 'EY', 'K', 'AH', 'N'], known: ['N', 'OW', 'N'],
    seen: ['S', 'IY', 'N'], begun: ['B', 'IH', 'G', 'AH', 'N'],
    chosen: ['CH', 'OW', 'Z', 'AH', 'N'], drawn: ['D', 'R', 'AO', 'N'],
    drunk: ['D', 'R', 'AH', 'NG', 'K'], driven: ['D', 'R', 'IH', 'V', 'AH', 'N'],
    eaten: ['IY', 'T', 'AH', 'N'], fallen: ['F', 'AO', 'L', 'AH', 'N'],
    flown: ['F', 'L', 'OW', 'N'], forgotten: ['F', 'ER', 'G', 'AA', 'T', 'AH', 'N'],
    gotten: ['G', 'AA', 'T', 'AH', 'N'], grown: ['G', 'R', 'OW', 'N'],
    ridden: ['R', 'IH', 'D', 'AH', 'N'], rung: ['R', 'AH', 'NG'],
    risen: ['R', 'IH', 'Z', 'AH', 'N'], spoken: ['S', 'P', 'OW', 'K', 'AH', 'N'],
    stolen: ['S', 'T', 'OW', 'L', 'AH', 'N'], swum: ['S', 'W', 'AH', 'M'],
    thrown: ['TH', 'R', 'OW', 'N'], worn: ['W', 'AO', 'R', 'N'],
    written: ['R', 'IH', 'T', 'AH', 'N'], broken: ['B', 'R', 'OW', 'K', 'AH', 'N'],
    shown: ['SH', 'OW', 'N'], sung: ['S', 'AH', 'NG'],
    woken: ['W', 'OW', 'K', 'AH', 'N'],
    been2: ['B', 'IH', 'N'],

    // ── Common nouns (song-lyrics vocabulary) ─────────────────────────────────
    heart: ['HH', 'AA', 'R', 'T'],
    soul: ['S', 'OW', 'L'], life: ['L', 'AY', 'F'],
    world: ['W', 'ER', 'L', 'D'], time: ['T', 'AY', 'M'],
    day: ['D', 'EY'], night: ['N', 'AY', 'T'],
    way: ['W', 'EY'], home: ['HH', 'OW', 'M'],
    rain: ['R', 'EY', 'N'], sun: ['S', 'AH', 'N'],
    fire: ['F', 'AY', 'ER'], water: ['W', 'AO', 'T', 'ER'],
    light: ['L', 'AY', 'T'], dark: ['D', 'AA', 'R', 'K'],
    dream: ['D', 'R', 'IY', 'M'], hope: ['HH', 'OW', 'P'],
    pain: ['P', 'EY', 'N'], joy: ['JH', 'OY'],
    tears: ['T', 'IH', 'R', 'Z'], eye: ['AY'],
    eyes: ['AY', 'Z'], mind: ['M', 'AY', 'N', 'D'],
    hand: ['HH', 'AE', 'N', 'D'], hands: ['HH', 'AE', 'N', 'D', 'Z'],
    voice: ['V', 'OY', 'S'], road: ['R', 'OW', 'D'],
    sky: ['S', 'K', 'AY'], star: ['S', 'T', 'AA', 'R'],
    stars: ['S', 'T', 'AA', 'R', 'Z'], moon: ['M', 'UW', 'N'],
    earth: ['ER', 'TH'], air: ['EH', 'R'],
    wind: ['W', 'IH', 'N', 'D'], sea: ['S', 'IY'],
    river: ['R', 'IH', 'V', 'ER'], ocean: ['OW', 'SH', 'AH', 'N'],
    mountain: ['M', 'AW', 'N', 'T', 'AH', 'N'],
    flower: ['F', 'L', 'AW', 'ER'], flowers: ['F', 'L', 'AW', 'ER', 'Z'],
    song: ['S', 'AO', 'NG'], music: ['M', 'Y', 'UW', 'Z', 'IH', 'K'],
    word: ['W', 'ER', 'D'], words: ['W', 'ER', 'D', 'Z'],
    door: ['D', 'AO', 'R'], floor: ['F', 'L', 'AO', 'R'],
    stone: ['S', 'T', 'OW', 'N'], bone: ['B', 'OW', 'N'],
    blood: ['B', 'L', 'AH', 'D'], breath: ['B', 'R', 'EH', 'TH'],
    truth: ['T', 'R', 'UW', 'TH'], youth: ['Y', 'UW', 'TH'],
    death: ['D', 'EH', 'TH'], faith: ['F', 'EY', 'TH'],
    ...
    space: ['S', 'P', 'EY', 'S'],
    grace: ['G', 'R', 'EY', 'S'],
    right: ['R', 'AY', 'T'], sight: ['S', 'AY', 'T'],
    bright: ['B', 'R', 'AY', 'T'], flight: ['F', 'L', 'AY', 'T'],
    tight: ['T', 'AY', 'T'],
    weight: ['W', 'EY', 'T'], height: ['HH', 'AY', 'T'],
    eight: ['EY', 'T'], eighteen: ['EY', 'T', 'IY', 'N'],
    straight: ['S', 'T', 'R', 'EY', 'T'],
    ...
    third: ['TH', 'ER', 'D'], fourth: ['F', 'AO', 'R', 'TH'],
    fifth: ['F', 'IH', 'F', 'TH'], last: ['L', 'AE', 'S', 'T'],

    // ── Common adjectives ─────────────────────────────────────────────────────
    good: ['G', 'UH', 'D'], bad: ['B', 'AE', 'D'],
    big: ['B', 'IH', 'G'], small: ['S', 'M', 'AO', 'L'],
    old: ['OW', 'L', 'D'], new: ['N', 'Y', 'UW'],
    high: ['HH', 'AY'], low: ['L', 'OW'],
    great: ['G', 'R', 'EY', 'T'], own: ['OW', 'N'],
    same: ['S', 'EY', 'M'], real: ['R', 'IY', 'L'],
    true: ['T', 'R', 'UW'], free: ['F', 'R', 'IY'],
    whole: ['HH', 'OW', 'L'], full: ['F', 'UH', 'L'],
    sure: ['SH', 'UH', 'R'], pure: ['P', 'Y', 'UH', 'R'],
    cold: ['K', 'OW', 'L', 'D'], warm: ['W', 'AO', 'R', 'M'],
    hot: ['HH', 'AA', 'T'], cool: ['K', 'UW', 'L'],
    loud: ['L', 'AW', 'D'], soft: ['S', 'AO', 'F', 'T'],
    wild: ['W', 'AY', 'L', 'D'], mild: ['M', 'AY', 'L', 'D'],
    blind: ['B', 'L', 'AY', 'N', 'D'], kind: ['K', 'AY', 'N', 'D'],
    wide: ['W', 'AY', 'D'], deep: ['D', 'IY', 'P'],
    young: ['Y', 'AH', 'NG'], strong: ['S', 'T', 'R', 'AO', 'NG'],
    wrong: ['R', 'AO', 'NG'],
    ...
    // kn-
    knife: ['N', 'AY', 'F'],
    knee: ['N', 'IY'], knight: ['N', 'AY', 'T'],
    knot: ['N', 'AA', 'T'], knock: ['N', 'AA', 'K'],
    kneel: ['N', 'IY', 'L'], knob: ['N', 'AA', 'B'],
    knowledge: ['N', 'AA', 'L', 'IH', 'JH'],
    // wr-
    wrap: ['R', 'AE', 'P'],
    wrist: ['R', 'IH', 'S', 'T'], wreck: ['R', 'EH', 'K'],
    wring: ['R', 'IH', 'NG'],
    // -mb (final)
    lamb: ['L', 'AE', 'M'], bomb: ['B', 'AA', 'M'],
    thumb: ['TH', 'AH', 'M'], comb: ['K', 'OW', 'M'],
    climb: ['K', 'L', 'AY', 'M'], limb: ['L', 'IH', 'M'],
    numb: ['N', 'AH', 'M'], dumb: ['D', 'AH', 'M'],
    tomb: ['T', 'UW', 'M'], womb: ['W', 'UW', 'M'],
    // -bt
    debt: ['D', 'EH', 'T'], doubt: ['D', 'AW', 'T'],
    subtle: ['S', 'AH', 'T', 'AH', 'L'],
    // -gh- (silent)
    daughter: ['D', 'AO', 'T', 'ER'],
    ...
    folk: ['F', 'OW', 'K'], yolk: ['Y', 'OW', 'K'],
    calm: ['K', 'AA', 'M'], palm: ['P', 'AA', 'M'],
    psalm: ['S', 'AA', 'M'], half: ['HH', 'AE', 'F'],
    calf: ['K', 'AE', 'F'],
    // h silent
    honest: ['AA', 'N', 'AH', 'S', 'T'],
    honor: ['AA', 'N', 'ER'], heir: ['EH', 'R'],
    // island
    island: ['AY', 'L', 'AH', 'N', 'D'], aisle: ['AY', 'L'],
    // iron
    iron: ['AY', 'ER', 'N'],
    // sword
    sword: ['S', 'AO', 'R', 'D'],
    ...
    // ── -ough / -augh words ───────────────────────────────────────────────────
    rough: ['R', 'AH', 'F'], tough: ['T', 'AH', 'F'],
    laugh: ['L', 'AE', 'F'],
    cough: ['K', 'AO', 'F'], ought: ['AO', 'T'],
    sought: ['S', 'AO', 'T'],
    dough: ['D', 'OW'],
    thorough: ['TH', 'ER', 'OW'],
    ...
    // ── o → AH (love-class) ───────────────────────────────────────────────────
    shove: ['SH', 'AH', 'V'],
    glove: ['G', 'L', 'AH', 'V'], dove: ['D', 'AH', 'V'],
    cover: ['K', 'AH', 'V', 'ER'], hover: ['HH', 'AH', 'V', 'ER'],
    lover: ['L', 'AH', 'V', 'ER'],
    money: ['M', 'AH', 'N', 'IY'], honey: ['HH', 'AH', 'N', 'IY'],
    monkey: ['M', 'AH', 'NG', 'K', 'IY'],
    donkey: ['D', 'AO', 'NG', 'K', 'IY'],
    month: ['M', 'AH', 'N', 'TH'], front: ['F', 'R', 'AH', 'N', 'T'],
    color: ['K', 'AH', 'L', 'ER'], comfort: ['K', 'AH', 'M', 'F', 'ER', 'T'],
    company: ['K', 'AH', 'M', 'P', 'AH', 'N', 'IY'],
    couple: ['K', 'AH', 'P', 'AH', 'L'], country: ['K', 'AH', 'N', 'T', 'R', 'IY'],
    cousin: ['K', 'AH', 'Z', 'AH', 'N'], double: ['D', 'AH', 'B', 'AH', 'L'],
    trouble: ['T', 'R', 'AH', 'B', 'AH', 'L'],
    tongue: ['T', 'AH', 'NG'],
    wonder: ['W', 'AH', 'N', 'D', 'ER'],
    number: ['N', 'AH', 'M', 'B', 'ER'],
    son: ['S', 'AH', 'N'], none: ['N', 'AH', 'N'],

    // ── Irregular vowel digraphs ──────────────────────────────────────────────
    says: ['S', 'EH', 'Z'],
    bread: ['B', 'R', 'EH', 'D'], dead: ['D', 'EH', 'D'],
    head: ['HH', 'EH', 'D'],  // past tense only
    lead: ['L', 'EH', 'D'],  // metal; verb form is EE
    spread: ['S', 'P', 'R', 'EH', 'D'],
    thread: ['TH', 'R', 'EH', 'D'], tread: ['T', 'R', 'EH', 'D'],
    dread: ['D', 'R', 'EH', 'D'], instead: ['IH', 'N', 'S', 'T', 'EH', 'D'],
    weather: ['W', 'EH', 'DH', 'ER'],
    feather: ['F', 'EH', 'DH', 'ER'],
    leather: ['L', 'EH', 'DH', 'ER'],
    ...
    heavy: ['HH', 'EH', 'V', 'IY'], ready: ['R', 'EH', 'D', 'IY'],
    steady: ['S', 'T', 'EH', 'D', 'IY'], jealous: ['JH', 'EH', 'L', 'AH', 'S'],
    health: ['HH', 'EH', 'L', 'TH'], wealth: ['W', 'EH', 'L', 'TH'],
    sweat: ['S', 'W', 'EH', 'T'], threat: ['TH', 'R', 'EH', 'T'],
    steak: ['S', 'T', 'EY', 'K'], bear: ['B', 'EH', 'R'],
    ...
    blow: ['B', 'L', 'OW'],
    flow: ['F', 'L', 'OW'],
    glow: ['G', 'L', 'OW'], crow: ['K', 'R', 'OW'],
    snow: ['S', 'N', 'OW'], slow: ['S', 'L', 'OW'],
    yellow: ['Y', 'EH', 'L', 'OW'],
    hollow: ['HH', 'AA', 'L', 'OW'],
    window: ['W', 'IH', 'N', 'D', 'OW'],
    elbow: ['EH', 'L', 'B', 'OW'], rainbow: ['R', 'EY', 'N', 'B', 'OW'],
    // -ou as other
    pour: ['P', 'AO', 'R'],
    tour: ['T', 'UH', 'R'],
    group: ['G', 'R', 'UW', 'P'],
    // -ei
    vein: ['V', 'EY', 'N'], rein: ['R', 'EY', 'N'],
    veil: ['V', 'EY', 'L'], reign: ['R', 'EY', 'N'],
    receive: ['R', 'IH', 'S', 'IY', 'V'],
    believe: ['B', 'IH', 'L', 'IY', 'V'],
    achieve: ['AH', 'CH', 'IY', 'V'],
...
const G2P_RULES: readonly G2pRule[] = [
    ...
    { m: 'b', o: ['B'] },  { m: 'd', o: ['D'] },  { m: 'f', o: ['F'] },
    { m: 'h', o: ['HH'] }, { m: 'j', o: ['JH'] }, { m: 'k', o: ['K'] },
    { m: 'l', o: ['L'] },  { m: 'm', o: ['M'] },  { m: 'n', o: ['N'] },
    { m: 'p', o: ['P'] },  { m: 'q', o: ['K'] },  { m: 'r', o: ['R'] },
    { m: 's', o: ['S'] },  { m: 't', o: ['T'] },  { m: 'v', o: ['V'] },
    { m: 'w', o: ['W'] },  { m: 'z', o: ['Z'] },
];
...
function applyG2p(word: string): string[] {
    ...
    while (pos < word.length) {
        ...
        for (const rule of G2P_RULES) {
            if (!word.startsWith(rule.m, pos)) continue;
            const left  = word.slice(0, pos);
            const right = word.slice(pos + rule.m.length);
            if (rule.p && !rule.p.test(left))  continue;
            if (rule.s && !rule.s.test(right)) continue;
        ...
        if (!matched) {
            ...
            const ch = word[pos]!;
            if (/[a-z]/.test(ch)) phonemes.push('AH');
            pos++;
        }
    }
    return phonemes;
