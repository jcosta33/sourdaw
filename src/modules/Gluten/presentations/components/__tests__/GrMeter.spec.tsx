...
describe('GrMeter', () => {
    ...
    it('should round aria-valuenow to one decimal to match the visible readout', () => {
        const { getByRole } = render(<GrMeter grDb={-4.234567} inputDb={-10} outputDb={-14} width={40} height={80} />);
    ...
    it('should use a per-instance label to disambiguate multiple meters', () => {
        const { getByLabelText } = render(
            <GrMeter grDb={-2} inputDb={-10} outputDb={-10} width={40} height={80} label="Bus A gain reduction" />
        );
