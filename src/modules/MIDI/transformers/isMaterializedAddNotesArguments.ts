...
function isMaterializedAddNote(value: unknown): value is MaterializedAddNote {
    if (!isRecord(value)) {
        return false;
    }
    return (
...
export function isMaterializedAddNotesArguments(value: unknown): value is MaterializedAddNotesArguments {
    return (
        isRecord(value) &&
