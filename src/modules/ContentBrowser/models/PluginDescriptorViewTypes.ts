/**
 * ContentBrowser-local view shape of Arrangement's PluginDescriptor /
 * DeviceParameter (AGENTS.md §95 — model isolation). These are NOT re-exports;
 * ContentBrowser owns its own types here containing the fields its views render.
 */
