...
- **`useCases`**:
    - **Plugin lifecycle & bridge**: `loadPlugin`, `unloadPlugin`, `openPluginGui`, `setPluginParameter`, `setPluginBypass`, `readPluginState`, `restorePluginState`, `activateExternalPlugin`, `clearLoadedExternalPlugins`, `refreshExternalPluginParameters`, `hasUnresolvedExternalPluginRestoreFailure`, `shouldWarnExternalPluginRestoreFailure`, `clearExternalPluginRestoreFailure`.
