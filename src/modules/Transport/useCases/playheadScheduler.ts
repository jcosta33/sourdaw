...
export const playheadSchedulerDependencies = {
    transportStore,
    playheadPositionRef,
    tempoMapStore,
    getTempoAtBeat,
...
export const startPlayheadScheduler = inject(playheadSchedulerDependencies)(
    ({
        transportStore,
        playheadPositionRef,
        tempoMapStore,
        ...
        function startPlayheadScheduler(): void {
...
export const stopPlayheadScheduler = inject(playheadSchedulerDependencies)(
    ({
        stopAutomationRecording,
        getAudioContext,
        resetMetronomeBeat,
        ...
        function stopPlayheadScheduler(): void {
            stopAutomationRecording();
            if (timerId !== null) {
