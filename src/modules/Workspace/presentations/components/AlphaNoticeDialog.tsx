        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            */}
            <DialogContent className="max-w-[480px] p-0 border-0 bg-transparent shadow-none overflow-visible">
                ...
                <div className="relative flex flex-col items-center gap-6 rounded-2xl border border-white/[0.07] bg-white/[0.03] backdrop-blur-xl shadow-[0_24px_80px_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,255,255,0.05)] p-10 text-center">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold tracking-tight text-white/90">
                                Welcome to the <span className="bg-gradient-to-r from-[var(--color-accent-orange)] via-amber-300 to-[var(--color-accent-peach)] bg-clip-text text-transparent">Test Kitchen</span>
                            </h2>
                    ...
                    <p className="text-sm text-white/60 leading-relaxed max-w-[340px]">
                        This app is in early alpha. This might be overproofed, and features will change. If you encounter any health code violations (bugs) or have suggestions, please use the <strong className="text-white/85">Talk to us</strong> button in the bottom right corner to join our Discord Bakery.
                    </p>
