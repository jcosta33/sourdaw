...
import { setNoteProbability } from '#/modules/MIDI/useCases/midiNoteCrud';
...
export const ProbabilityLane = ({ clipId, trackId, selectedNoteIds, beatWidth, contentWidth }: ProbabilityLaneProps): ReactElement => {
    ...
    useEffect(() => {
        ...
        for (const note of notes) {
            ...
            const alpha = 0.35 + (prob / 100) * 0.55;
