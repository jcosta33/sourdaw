...
import { Save, X, ChevronRight, Star, Folder, Music2, Drum, Music, Piano } from 'lucide-react';
...
import { InstrumentCard, FERMENTER_THEME, TOASTER_THEME, LEVAIN_THEME, GRAND_BOULE_THEME } from '../../components/Sidebar/InstrumentCard';
...
const CUSTOM_UI_DEVICE_TYPES = new Set(['fermenter', 'toaster', 'levain', 'grand-boule']);
