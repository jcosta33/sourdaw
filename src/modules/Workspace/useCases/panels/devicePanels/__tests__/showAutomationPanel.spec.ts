...
describe('showAutomationPanel', () => {
    it('is a function', () => { expect(typeof showAutomationPanel).toBe('function'); });
    it('runs without crash', () => { expect(() => (showAutomationPanel as (id: string | null) => void)('test-id')).not.toThrow(); });
});
