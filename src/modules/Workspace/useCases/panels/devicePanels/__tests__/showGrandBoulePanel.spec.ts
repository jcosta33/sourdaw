...
describe('showGrandBoulePanel', () => {
    it('is a function', () => { expect(typeof showGrandBoulePanel).toBe('function'); });
    it('runs without crash', () => { expect(() => (showGrandBoulePanel as (id: string | null) => void)('test-id')).not.toThrow(); });
});
