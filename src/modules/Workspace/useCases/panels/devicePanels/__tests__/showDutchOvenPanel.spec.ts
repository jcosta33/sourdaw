...
describe('showDutchOvenPanel', () => {
    it('is a function', () => { expect(typeof showDutchOvenPanel).toBe('function'); });
    it('runs without crash', () => { expect(() => (showDutchOvenPanel as (id: string | null) => void)('test-id')).not.toThrow(); });
});
