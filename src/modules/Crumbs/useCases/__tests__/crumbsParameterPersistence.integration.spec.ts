 ...
 * Only `updateDeviceParam` is stubbed, because it addresses a live AudioContext that
 * does not exist under Vitest — which is also what lets the drag guard count engine
 * writes and prove the transient half still reaches audio.
 */
