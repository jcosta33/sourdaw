...
// Scoring WASM-view lifecycle (audit RT-1 / RT-7): two output views mapped over
// WASM memory, revalidated against a post-`process()` re-read of the live buffer.
...
const FRAMES = 128;
const GROWN_LEFT_BASE = 700;
const GROWN_RIGHT_BASE = 300;
...
describe('ScoringProcessor WASM-view lifecycle (audit RT-1 / RT-7)', () => {
    beforeEach(() => {
