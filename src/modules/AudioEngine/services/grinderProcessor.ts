...
class GrinderProcessor extends AudioWorkletProcessor {
        ...
        this.port.onmessage = (e) => {
            ...
            try {
                if (msg.type === 'init') {
                    ...
                    this._wasm.grinderinstance_note_on(this._ptr, msg.pad, msg.velocity, msg.note ?? 60);
                } else if (msg.type === 'noteOff' && this._ready) {
                    this._wasm.grinderinstance_note_off(this._ptr, msg.pad);
    ...
    _initWasm(wasmBytes) {
        ...
        this._ptr = w.grinderinstance_new(sampleRate, 16) >>> 0;
        this._ready = true;
    ...
    _setPadParam(pad, name, value) {
        ...
        w.grinderinstance_set_pad_param(this._ptr, pad, strPtr, len, value);
    }
    ...
    process(_inputs, outputs) {
        ...
        const leftPtr = w.grinderinstance_process(this._ptr, frames) >>> 0;
        const rightPtr = w.grinderinstance_get_right_ptr(this._ptr) >>> 0;
