...
describe('createOfflineTrackStrip', () => {
    ...
    /// content for "later use in a DAW" (mixdown muting happens by
    /// excluding muted tracks from clip scheduling, not by zeroing stems).
    it('keeps the stem audible for a muted track', async () => {
