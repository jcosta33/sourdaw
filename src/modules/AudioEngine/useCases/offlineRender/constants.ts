 ...
 * device parameter.
 *
 * The lane set lives in `#/utils/mixerAutomation` so every consumer shares one
 * definition; re-exported here for this subtree's existing importers.
 */
export { MIXER_AUTOMATION_PARAMETER_IDS } from '#/utils/mixerAutomation';
