...
export class DutchOvenInstance {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        DutchOvenInstanceFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_dutchoveninstance_free(ptr, 0);
    }
    /**
     ...
     */
    get_latency() {
        const ret = wasm.dutchoveninstance_get_latency(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {string}
    ...
    get_param_names() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.dutchoveninstance_get_param_names(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get_right_ptr() {
        const ret = wasm.dutchoveninstance_get_right_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    load_ir(ir_data, channels) {
        ...
        wasm.dutchoveninstance_load_ir(this.__wbg_ptr, ptr0, len0, channels);
    }
    /**
     * @param {number} sample_rate
     */
    constructor(sample_rate) {
        const ret = wasm.dutchoveninstance_new(sample_rate);
        this.__wbg_ptr = ret >>> 0;
        DutchOvenInstanceFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    process(left_in, right_in, frames) {
        ...
        const ret = wasm.dutchoveninstance_process(this.__wbg_ptr, ptr0, len0, ptr1, len1, frames);
        return ret >>> 0;
    }
    /**
     * @param {string} name
    ...
    set_param(name, value) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.dutchoveninstance_set_param(this.__wbg_ptr, ptr0, len0, value);
    }
}
if (Symbol.dispose) DutchOvenInstance.prototype[Symbol.dispose] = DutchOvenInstance.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./dutch_oven_bg.js": import0,
    };
}

const DutchOvenInstanceFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_dutchoveninstance_free(ptr >>> 0, 1));
