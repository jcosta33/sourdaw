...
let wasm_bindgen = (function(exports) {
    ...
    exports.BacteriaInstance = BacteriaInstance;

    /**
     * WASM-exported Fermenter instance for AudioWorklet.
     */
    class FermenterInstance {
        __destroy_into_raw() {
            const ptr = this.__wbg_ptr;
            this.__wbg_ptr = 0;
    ...
    exports.GrandBouleInstance = GrandBouleInstance;

    /**
     * WASM-exported Grinder instance for AudioWorklet.
     */
    class GrinderInstance {
        __destroy_into_raw() {
            const ptr = this.__wbg_ptr;
            this.__wbg_ptr = 0;
    ...
    exports.GrinderInstance = GrinderInstance;
    ...
    exports.KneadInstance = KneadInstance;

    /**
     * WASM-exported Levain instance for AudioWorklet.
     */
    class LevainInstance {
        __destroy_into_raw() {
            const ptr = this.__wbg_ptr;
            this.__wbg_ptr = 0;
    ...
    exports.LevainInstance = LevainInstance;
    ...
    exports.ProofInstance = ProofInstance;
    ...
    exports.ToasterInstance = ToasterInstance;
