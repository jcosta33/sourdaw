/**
 * The repository root for the three native graph commands, and the transport
 * seam the native backend renders through.
 *
...
/** The production carrier: the three commands over the desktop bridge. */
