/**
 * Sampler parameter controls — mode switcher, envelope knobs, filter knobs.
 */

import { type ReactElement } from 'react';
import { DawPluginChip } from '#/components/daw/DawPluginChip';
import { RotaryKnob } from '#/components/daw/RotaryKnob';
import type { EnvelopeParams, FilterType, SamplerMode, VoiceStackParams } from '../../models/SamplerTypes';
...
type SamplerControlsProps = {
    ...
    onModeChange: (mode: SamplerMode) => void;
...
const MODES: SamplerMode[] = ['quick', 'drum', 'slice', 'warp', 'record'];
...
export const SamplerControls = ({
    ...
    onPanChange,
    onStackChange,
}: SamplerControlsProps): ReactElement => {
    return (
