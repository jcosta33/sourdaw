/**
 * Unified Sampler Suite domain types.
 * Plain types describing sampler state — no behavior, no framework dependencies.
 */

export type SamplerMode = 'quick' | 'drum' | 'slice' | 'warp' | 'record';
