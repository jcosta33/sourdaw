...
import { type GrinderKit, createDefaultKit, createDefaultPad } from '../models/GrinderKit';

export type GrinderKitPreset = {
    id: string;
    name: string;
    description: string;
    tags: string[];
...
function kit(id: string, name: string, desc: string, tags: string[], overrides: Partial<GrinderKit>): GrinderKitPreset {
    return { id, name, description: desc, tags: ['grinder', ...tags], kit: { ...createDefaultKit(), name, ...overrides } };
}

export const GRINDER_PRESETS: GrinderKitPreset[] = [
