 ...
 */
export function handleKeydown(desc: KeyDescriptor): boolean {
...
function handleSimpleKeys(key: string, shift: boolean): boolean {
    switch (key) {
        case 'Escape': {
 ...
 */
export function handleKeyup(key: string): void {
    if (key === 'v') {
