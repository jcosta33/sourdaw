 ...
 * deferred writes and before it serializes bytes for IndexedDB (#3331-repair-2,
 * E1), so the witness this writes matches exactly what becomes durable. A
 * no-op when the live stacks carry no project/document owner.
 */
