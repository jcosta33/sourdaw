...
describe('goToPreviousMarker', () => {
    ...
    it('seeks to the latest marker strictly before the playhead', () => {
        ...
        mocks.getTransportState.mockReturnValue({ playheadPosition: 10 } as ReturnType<typeof getTransportState>);
    ...
    it('does not seek when every marker is at or after the playhead', () => {
        ...
        mocks.getTransportState.mockReturnValue({ playheadPosition: 4 } as ReturnType<typeof getTransportState>);
