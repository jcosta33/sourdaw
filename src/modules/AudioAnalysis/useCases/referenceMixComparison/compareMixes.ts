import { type FrequencyBand, type MixAnalysis, type MixComparisonResult, type MixSuggestion, FREQUENCY_RANGES } from '#/modules/AudioAnalysis/models/MixComparisonTypes';
