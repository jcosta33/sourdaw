 ...
 */
export const insertPolyphonicMidiNotes = inject(insertPolyphonicMidiNotesDependencies)(
    ({ getTransportState, getAllTracks, addTrack, addClip, batchAddMidiNotes }) =>
        function insertPolyphonicMidiNotes(
            notes: NoteEventTime[],
