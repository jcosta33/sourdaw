...
function pickProgression(style: ChordProgressionStyle): Progression {
...
export function generateChordProgression(options: GenerateChordProgressionOptions): GeneratedNote[] {
    const { style, key, scale, bars = 4, voicing = 'close', octave = 3, rhythm = 'whole' } = options;
