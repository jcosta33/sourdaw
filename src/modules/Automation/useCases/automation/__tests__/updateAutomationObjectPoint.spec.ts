            ...
            lanes: [
                {
                    ...
                    points: [],
                    objects: [
                        { id: 'o1', poolId: 'pool1', laneId: 'l1', startBeat: 0, endBeat: 4, points: [{ beat: 1, value: 0.5, curve: 'linear', tension: 0 }], name: 'Obj 1' },
                        { id: 'o2', poolId: 'pool1', laneId: 'l1', startBeat: 8, endBeat: 12, points: [{ beat: 1, value: 0.5, curve: 'linear', tension: 0 }], name: 'Obj 2' },
                    ],
                    visible: true,
                    enabled: true,
                    collapsed: false,
