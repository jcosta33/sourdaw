...
describe('setYeastGrooveTemplate', () => {
    ...
    it('preserves concurrent processor edits while refreshing runtime from current state', async () => {
    ...
    it('commits only the MIDI-owned assignment as one project change and one undo entry', async () => {
