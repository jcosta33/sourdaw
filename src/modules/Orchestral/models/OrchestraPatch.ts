/**
 * Orchestral instrument patch data model.
 * Describes the complete state of an orchestral instrument — serializable, versionable.
 *
 * The orchestral suite is primarily a sample playback and performance intelligence
...
export function createDefaultPatch(instrumentId: InstrumentId = 'violin-1'): OrchestraPatch {
