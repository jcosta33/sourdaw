...
export function registerBuiltinFaustDSP(): void {
    ...
    `, [
        ...
        { address: '/1176/attack', label: 'Attack', min: 0.0001, max: 0.1, defaultValue: 0.001, step: 0.0001, type: 'hslider', scaling: 'log' },
        { address: '/1176/release', label: 'Release', min: 0.01, max: 1, defaultValue: 0.1, step: 0.001, type: 'hslider', scaling: 'log' },
    ]);
    ...
    `, [
        ...
        { address: '/limiter/release', label: 'Release', min: 10, max: 500, defaultValue: 100, step: 1, type: 'hslider', scaling: 'log' },
    ...
    `, [
        { address: '/spring/decay', label: 'Decay', min: 0.1, max: 8, defaultValue: 2, step: 0.1, type: 'hslider', scaling: 'log' },
    ...
    `, [
        { address: '/fm_synth/algorithm', label: 'Algorithm', min: 0, max: 3, defaultValue: 0, step: 1, type: 'hslider' },
        
        { address: '/fm_synth/op1_ratio', label: 'OP1 Ratio', min: 0.5, max: 16, defaultValue: 1, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op1_level', label: 'OP1 Level', min: 0, max: 1, defaultValue: 1, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op1_attack', label: 'OP1 Attack', min: 0.001, max: 5, defaultValue: 0.01, step: 0.001, type: 'hslider' },
        { address: '/fm_synth/op1_decay', label: 'OP1 Decay', min: 0.01, max: 5, defaultValue: 0.1, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op1_sustain', label: 'OP1 Sustain', min: 0, max: 1, defaultValue: 0.8, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op1_release', label: 'OP1 Release', min: 0.01, max: 10, defaultValue: 0.5, step: 0.01, type: 'hslider' },
        
        { address: '/fm_synth/op2_ratio', label: 'OP2 Ratio', min: 0.5, max: 16, defaultValue: 2, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op2_level', label: 'OP2 Level', min: 0, max: 1, defaultValue: 0.5, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op2_attack', label: 'OP2 Attack', min: 0.001, max: 5, defaultValue: 0.01, step: 0.001, type: 'hslider' },
        { address: '/fm_synth/op2_decay', label: 'OP2 Decay', min: 0.01, max: 5, defaultValue: 0.1, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op2_sustain', label: 'OP2 Sustain', min: 0, max: 1, defaultValue: 0.8, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op2_release', label: 'OP2 Release', min: 0.01, max: 10, defaultValue: 0.5, step: 0.01, type: 'hslider' },
        
        { address: '/fm_synth/op3_ratio', label: 'OP3 Ratio', min: 0.5, max: 16, defaultValue: 3, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op3_level', label: 'OP3 Level', min: 0, max: 1, defaultValue: 0.5, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op3_attack', label: 'OP3 Attack', min: 0.001, max: 5, defaultValue: 0.01, step: 0.001, type: 'hslider' },
        { address: '/fm_synth/op3_decay', label: 'OP3 Decay', min: 0.01, max: 5, defaultValue: 0.1, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op3_sustain', label: 'OP3 Sustain', min: 0, max: 1, defaultValue: 0.8, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op3_release', label: 'OP3 Release', min: 0.01, max: 10, defaultValue: 0.5, step: 0.01, type: 'hslider' },

        { address: '/fm_synth/op4_ratio', label: 'OP4 Ratio', min: 0.5, max: 16, defaultValue: 4, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op4_level', label: 'OP4 Level', min: 0, max: 1, defaultValue: 0.5, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op4_attack', label: 'OP4 Attack', min: 0.001, max: 5, defaultValue: 0.01, step: 0.001, type: 'hslider' },
        { address: '/fm_synth/op4_decay', label: 'OP4 Decay', min: 0.01, max: 5, defaultValue: 0.1, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op4_sustain', label: 'OP4 Sustain', min: 0, max: 1, defaultValue: 0.8, step: 0.01, type: 'hslider' },
        { address: '/fm_synth/op4_release', label: 'OP4 Release', min: 0.01, max: 10, defaultValue: 0.5, step: 0.01, type: 'hslider' },
    ...
    `, [
        ...
        { address: '/Noise_Gate/attack', label: 'Attack', min: 0.0001, max: 0.1, defaultValue: 0.001, step: 0.0001, type: 'hslider', scaling: 'log' },
        { address: '/Noise_Gate/hold', label: 'Hold', min: 0, max: 0.5, defaultValue: 0.01, step: 0.001, type: 'hslider' },
        { address: '/Noise_Gate/release', label: 'Release', min: 0.01, max: 1, defaultValue: 0.1, step: 0.001, type: 'hslider', scaling: 'log' },
    ]);
    ...
    `, [
        ...
        { address: '/Minimoog_Lead/lfo_rate', label: 'LFO Rate', min: 0.1, max: 20, defaultValue: 5, step: 0.1, type: 'hslider' },
        { address: '/Minimoog_Lead/lfo_depth', label: 'LFO Depth', min: 0, max: 1, defaultValue: 0, step: 0.01, type: 'hslider' },
        ...
        { address: '/Minimoog_Lead/attack', label: 'Attack', min: 0.001, max: 5, defaultValue: 0.005, step: 0.001, type: 'hslider', scaling: 'log' },
        { address: '/Minimoog_Lead/decay', label: 'Decay', min: 0.01, max: 5, defaultValue: 0.25, step: 0.01, type: 'hslider', scaling: 'log' },
        { address: '/Minimoog_Lead/sustain', label: 'Sustain', min: 0, max: 1, defaultValue: 0.6, step: 0.01, type: 'hslider' },
        { address: '/Minimoog_Lead/release', label: 'Release', min: 0.01, max: 5, defaultValue: 0.3, step: 0.01, type: 'hslider', scaling: 'log' },
    ...
    `, [
        { address: '/Acid_Bass_303/lfo_rate', label: 'LFO Rate', min: 0.1, max: 20, defaultValue: 5, step: 0.1, type: 'hslider' },
        { address: '/Acid_Bass_303/lfo_depth', label: 'LFO Depth', min: 0, max: 1, defaultValue: 0, step: 0.01, type: 'hslider' },
        { address: '/Acid_Bass_303/cutoff', label: 'Cutoff', min: 0.01, max: 1, defaultValue: 0.3, step: 0.001, type: 'hslider', scaling: 'log' },
        ...
        { address: '/Acid_Bass_303/decay', label: 'Decay', min: 0.01, max: 1, defaultValue: 0.15, step: 0.01, type: 'hslider', scaling: 'log' },
