/**
 * useWorkspaceState — MixerConsole-local read of Workspace's public workspace
 * store (a cross-module read contract). The mixer surface only consumes
 * `channelStripWidth`, but returning the full state keeps the hook shape
