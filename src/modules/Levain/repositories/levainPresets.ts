...
import { type LevainPatch, type InstrumentId, createDefaultPatch } from '../models/LevainPatch';
...
export const FACTORY_PRESETS: PresetEntry[] = [
    ...
    {
        id: 'str-vln1-legato',
        name: 'Violins I — Legato',
        category: 'strings',
        level: 'play',
        description: 'Expressive legato violins with natural vibrato',
        instrumentId: 'violin-1',
    },
    {
        id: 'str-vln1-spiccato',
        name: 'Violins I — Spiccato',
        category: 'strings',
        level: 'play',
        description: 'Crisp short bowing',
        instrumentId: 'violin-1',
    },
    {
        id: 'str-cello-sustain',
        name: 'Cellos — Sustain',
        category: 'strings',
        level: 'play',
        description: 'Warm sustained cellos',
        instrumentId: 'cello',
    },
    {
        id: 'str-bass-pizz',
        name: 'Basses — Pizzicato',
        category: 'strings',
        level: 'play',
        description: 'Deep plucked basses',
    ...
    // Brass — Play level
    {
        ...
        category: 'brass',
        level: 'play',
        description: 'Noble French horns',
        instrumentId: 'horn',
    },
    {
        id: 'brs-trumpet-stac',
        ...
        category: 'brass',
        level: 'play',
        description: 'Heroic short brass',
    ...
    // Woodwinds — Play level
    {
        ...
        category: 'woodwinds',
        level: 'play',
        description: 'Singing solo flute',
        instrumentId: 'flute',
    },
    {
        id: 'ww-oboe-sustain',
        ...
        category: 'woodwinds',
        level: 'play',
        description: 'Expressive solo oboe',
        instrumentId: 'oboe',
    },
    // Percussion — Play level
    {
        ...
        category: 'percussion',
        level: 'play',
        description: 'Standard timpani with rolls',
    ...
    // Ensemble — Build level
    {
        ...
        category: 'ensemble',
        level: 'build',
        description: 'Vln1 + Vln2 + Vla + Vc + Cb pre-panned',
        instrumentId: 'violin-1',
    },
    {
        id: 'ens-brass-section',
        name: 'Brass Section',
        category: 'ensemble',
        level: 'build',
        description: 'Hrn + Tpt + Tbn + Tba',
        instrumentId: 'horn',
    },
];
