/**
 * LevainPresetBrowser — browse and load levain presets.
 *
...
import {
    ...
    type PresetEntry,
    type PresetCategory,
} from '../../repositories/levainPresets';
import { loadFactoryPreset } from '../../useCases/loadPreset';
import { type LevainUiLevel } from '../../stores/levainStore';

type LevainPresetBrowserProps = {
...
export const LevainPresetBrowser = ({
    currentPresetName,
    uiLevel,
}: LevainPresetBrowserProps): ReactElement => {
