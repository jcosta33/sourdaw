...
const DEVICE_LANES: readonly DeviceLaneSpec[] = [
    ...
    ['Dub Tunnel', 'builtin-delay', ['delay-feedback', 'delay-mix']],
    ['Temple Chamber', 'dutch-oven', ['decay', 'mix']],
...
const PARAMETER_RANGES: Readonly<Record<string, ParameterRange>> = {
    'toaster:masterGain': [0, 2],
    'toaster:swing': [0, 1],
    'toaster:reverbMix': [0, 1],
    'toaster:delayMix': [0, 1],
    'fermenter:oscLevel': [0, 1],
    'fermenter:filterCutoff': [20, 20_000],
    'fermenter:filterResonance': [0.5, 20],
    'fermenter:lfoRate': [0, 5_000],
    ...
    'fermenter:fmFeedback': [0, 1],
    'fermenter:noiseLevel': [0, 1],
    'fermenter:grainDensity': [1, 100],
    'fermenter:grainSize': [5, 500],
    'fermenter:grainSpray': [0, 1],
    'builtin-filter:filter-cutoff': [20, 20_000],
    'builtin-filter:filter-resonance': [0.1, 20],
    'builtin-distortion:dist-mix': [0, 1],
    'builtin-delay:delay-feedback': [0, 0.95],
    'builtin-delay:delay-mix': [0, 1],
    'dutch-oven:decay': [0, 0.999],
    'dutch-oven:mix': [0, 1],
    'builtin-autopan:autopan-rate': [0.1, 10],
    'builtin-autopan:autopan-depth': [0, 1],
    'builtin-phaser:phaser-rate': [0.1, 10],
    'builtin-phaser:phaser-depth': [0, 1],
    'builtin-chorus:chorus-rate': [0.1, 10],
    'builtin-chorus:chorus-depth': [0, 20],
    'builtin-tremolo:trem-rate': [0.1, 20],
    'builtin-tremolo:trem-depth': [0, 1],
    'builtin-stereo-widener:width-amount': [0, 3],
};
