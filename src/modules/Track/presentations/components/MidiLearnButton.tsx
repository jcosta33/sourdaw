...
import { midiLearnStore, type LearningTarget, type MidiMappingTargetType, type MidiLearnState } from "../../stores/midiLearnStore";
import {
    startMidiLearn,
    stopMidiLearn,
    findMappingForTarget,
} from "../../useCases/midiLearnUseCases";
...
const subscribe = (callback: () => void): (() => void) =>
    midiLearnStore.subscribe(() => callback());

const getSnapshot = (): MidiLearnState | null =>
...
export const MidiLearnButton = ({
    targetType,
    trackId,
    deviceId,
    paramId,
}: MidiLearnButtonProps): ReactElement => {
    ...
    const isLearningThis =
        ...
        state.learningTarget !== null &&
        isTargetMatch(state.learningTarget, target);
        ...
        <Tooltip>
            <TooltipTrigger asChild>
                <Button
                    ...
                    onClick={handleClick}
                >
                    {existingMapping && !isLearningThis
                        ? existingMapping.cc
                        : "M"}
                </Button>
            </TooltipTrigger>
