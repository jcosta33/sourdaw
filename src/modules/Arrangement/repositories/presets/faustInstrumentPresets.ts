...
export const FAUST_INSTRUMENT_PRESETS: SoundPreset[] = [
    ...
    },
    {
        ...
        devices: [
            ...
            reverb('Room', { 'rev-size': 0.3, 'rev-decay': 1.5, 'rev-mix': 0.2 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            comp('Punch', { 'comp-threshold': -14, 'comp-ratio': 4, 'comp-attack': 5, 'comp-release': 80 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            comp('Compressor', { 'comp-threshold': -12, 'comp-ratio': 4, 'comp-attack': 3, 'comp-release': 60 }),
            reverb('Room', { 'rev-size': 0.25, 'rev-decay': 0.8, 'rev-mix': 0.15 }),
        ],
...

    {
        ...
        devices: [
            ...
            comp('Evenness', { 'comp-threshold': -18, 'comp-ratio': 3, 'comp-attack': 8, 'comp-release': 120 }),
        ],
...

    {
        ...
        devices: [
            ...
            reverb('Room', { 'rev-size': 0.4, 'rev-decay': 1.8, 'rev-mix': 0.2 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            comp('Sustain', { 'comp-threshold': -15, 'comp-ratio': 5, 'comp-attack': 3, 'comp-release': 60 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            eq('Low-End', { 'eq-low-gain': 4, 'eq-low-freq': 80, 'eq-mid-gain': -2, 'eq-mid-freq': 400 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            delay('Delay', { 'delay-time': 350, 'delay-feedback': 0.3, 'delay-mix': 0.2 }),
            reverb('Space', { 'rev-size': 0.5, 'rev-decay': 2.5, 'rev-mix': 0.25 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            comp('Compressor', { 'comp-threshold': -12, 'comp-ratio': 6 }),
            eq('Low-End', { 'eq-low-gain': 3, 'eq-low-freq': 80, 'eq-mid-gain': 2, 'eq-mid-freq': 1200 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            reverb('Room', { 'rev-size': 0.3, 'rev-decay': 1.2, 'rev-mix': 0.18 }),
        ],
...

    {
        ...
        devices: [
            ...
            comp('Punch', { 'comp-threshold': -14, 'comp-ratio': 4, 'comp-attack': 5, 'comp-release': 60 }),
            eq('Low-End', { 'eq-low-gain': 3, 'eq-low-freq': 80, 'eq-high-gain': -2, 'eq-high-freq': 8000 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            comp('Squash', { 'comp-threshold': -10, 'comp-ratio': 6, 'comp-attack': 2, 'comp-release': 50 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            comp('Compressor', { 'comp-threshold': -16, 'comp-ratio': 3, 'comp-attack': 8, 'comp-release': 100 }),
            eq('Warmth', { 'eq-low-gain': 4, 'eq-low-freq': 70, 'eq-high-gain': -4, 'eq-high-freq': 6000 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            comp('Limiter', { 'comp-threshold': -8, 'comp-ratio': 8, 'comp-attack': 1, 'comp-release': 40 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            comp('Glue', { 'comp-threshold': -16, 'comp-ratio': 3, 'comp-attack': 8, 'comp-release': 100 }),
        ],
...

    {
        ...
        devices: [
            ...
            delay('Dotted', { 'delay-time': 375, 'delay-feedback': 0.3, 'delay-mix': 0.2 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            reverb('Room', { 'rev-size': 0.3, 'rev-decay': 1.0, 'rev-mix': 0.15 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            comp('Compressor', { 'comp-threshold': -15, 'comp-ratio': 5 }),
            eq('Low-End', { 'eq-low-gain': 3, 'eq-low-freq': 80, 'eq-high-gain': -3, 'eq-high-freq': 6000 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            delay('Stutter', { 'delay-time': 80, 'delay-feedback': 0.5, 'delay-mix': 0.3 }),
            reverb('Space', { 'rev-size': 0.6, 'rev-decay': 2.5, 'rev-mix': 0.25 }),
        ],
...

    {
        ...
        devices: [
            ...
            eq('Warmth', { 'eq-low-gain': 2, 'eq-low-freq': 250, 'eq-mid-gain': -1, 'eq-mid-freq': 2000 }),
    ...
    },
    {
        ...
        devices: [
            ...
            eq('Shimmer', { 'eq-high-gain': 5, 'eq-high-freq': 10000, 'eq-mid-gain': -3, 'eq-mid-freq': 500 }),
            chorus('Stereo', { 'chorus-rate': 0.4, 'chorus-depth': 6, 'chorus-mix': 0.3 }),
            delay('Sparkle', { 'delay-time': 120, 'delay-feedback': 0.25, 'delay-mix': 0.15 }),
            reverb('Hall', { 'rev-size': 0.7, 'rev-decay': 4, 'rev-damping': 0.3, 'rev-mix': 0.35 }),
        ],
...

    {
        ...
        devices: [
            ...
            eq('Body', { 'eq-low-gain': 2, 'eq-low-freq': 150, 'eq-mid-gain': 1, 'eq-mid-freq': 800 }),
            comp('Sustain', { 'comp-threshold': -20, 'comp-ratio': 3, 'comp-attack': 2, 'comp-release': 150 }),
    ...
    },
    {
        ...
        devices: [
            ...
            eq('Sparkle', { 'eq-high-gain': 4, 'eq-high-freq': 6000, 'eq-mid-gain': -2, 'eq-mid-freq': 400 }),
            chorus('Width', { 'chorus-rate': 0.6, 'chorus-depth': 4, 'chorus-mix': 0.25 }),
            reverb('Chamber', { 'rev-size': 0.5, 'rev-decay': 2.5, 'rev-damping': 0.3, 'rev-mix': 0.3 }),
        ],
    ...
    },
    {
        ...
        devices: [
            ...
            eq('Brightness', { 'eq-high-gain': 3, 'eq-high-freq': 5000, 'eq-low-gain': -2, 'eq-low-freq': 200 }),
            delay('Echo', { 'delay-time': 180, 'delay-feedback': 0.3, 'delay-mix': 0.2 }),
