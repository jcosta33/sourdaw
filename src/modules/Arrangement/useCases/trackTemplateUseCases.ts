...
import { loadTrackTemplates, saveTrackTemplates } from '../repositories/trackTemplateRepository';
import { getTrackById, getTrackState, setTrackState } from '../repositories/trackRepository';
import { createTrack } from '../models/Track';

let templateCache: TrackTemplate[] | null = null;

function ensureCache(): TrackTemplate[] {
    if (templateCache === null) {
        templateCache = loadTrackTemplates();
    }
