...
export const SIDEBAR_INSTRUMENT_PRESETS: readonly SoundPreset[] = Object.freeze([
    ...
    },
    {
        ...
        name: 'Toaster Kit',
        category: 'drums',
        description: 'Toaster drum machine',
        trackKind: 'folder',
        devices: [{ type: 'toaster', name: 'Toaster', parameterValues: {} }],
        tags: ['drums', 'toaster', 'pads'],
        author: 'Sourdaw',
        isFactory: true,
    },
    {
        id: 'grand-boule-default',
        name: 'Grand Boule',
        category: 'keys',
        description: 'Grand Boule piano',
        trackKind: 'midi',
        devices: [{ type: 'grand-boule', name: 'Grand Boule', parameterValues: {} }],
        tags: ['piano', 'grand-boule', 'keys'],
        author: 'Sourdaw',
        isFactory: true,
    },
]);
