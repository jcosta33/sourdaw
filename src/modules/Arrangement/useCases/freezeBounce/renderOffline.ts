...
export const renderTrackOfflineDependencies = {
    buildDeviceChain,
    getAudioContext,
} as const;

export const renderTrackOffline = inject(renderTrackOfflineDependencies)(
    ({ buildDeviceChain, getAudioContext }) =>
        async function renderTrackOffline(
            track: Track,
            startBeat: number,
            endBeat: number
