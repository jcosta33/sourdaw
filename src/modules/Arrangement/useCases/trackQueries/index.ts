...
export type { MidiNote, MidiCC, MidiPitchBend } from '#/modules/MIDI/useCases/midiUseCases';
export type { AutomationLane, AutomationPoint, AutomationCurveType } from '#/modules/Automation/useCases/automationUseCases';
export { createAutomationLane } from '#/modules/Automation/useCases/automationUseCases';
...
export { createMidiNote } from '#/modules/MIDI/useCases/midiUseCases';
