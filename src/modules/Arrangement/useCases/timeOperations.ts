...
export const insertTime = inject({ getTrackState, setTrackState })(
    ({ getTrackState, setTrackState }) =>
...
export const duplicateTimeRange = inject({ getTrackState, setTrackState })(
    ({ getTrackState, setTrackState }) =>
        function duplicateTimeRange(startBeat: number, endBeat: number): void {
            const duration = endBeat - startBeat;
