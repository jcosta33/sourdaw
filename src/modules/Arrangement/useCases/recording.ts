...
export const armTrack = inject({ updateTrack, getTrackById })(
    ({ updateTrack, getTrackById }) =>
        function armTrack(trackId: string, armed: boolean): void {
...
export const startRecording = inject({ getTrackState, setTrackState })(
    ({ getTrackState, setTrackState }) =>
        function startRecording(): Clip[] {
...
export const stopRecording = inject({ getTrackState, setTrackState })(
    ({ getTrackState, setTrackState }) =>
        function stopRecording(clipIds: string[]): void {
