...
export function getNextGroupId(): string { return `grp-${groupId++}`; }
export function getNextTakeSetId(): string { return `ts-${takeSetId++}`; }
export function getNextRegionId(): string { return `gr-${regionId++}`; }
