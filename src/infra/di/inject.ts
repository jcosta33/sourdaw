...
type ResolveDependency<TDep> =
    TDep extends new (...args: any[]) => infer TInstance ? TInstance : TDep;
...
export const inject = <TDeps extends Record<string, unknown>>(
    deps: TDeps,
            ...
            try {
                ...
                for (const [key, dep] of Object.entries(deps)) {
                    ...
                    if (override !== undefined) {
                        ...
                        resolved = dep;
                    } else if (dep !== null && typeof dep === 'object' && (dep as InjectableFunction)._isInjectable) {
                        resolved = dep;
